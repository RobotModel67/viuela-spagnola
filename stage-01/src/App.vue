  ...
  <div id="app">
    ...
    <div class="container-fluid p-4">
      ...
      <div class="row bg-secondary py-2 mt-2 text-white">
        <div class="col text-center">
          <input type="checkbox" v-model="hiddeCompleted" class="form-check-input" />
          <label for class="form-check-label font-weight-bold">Hide completed tasks</label>
        </div>
        <div class="col text-center">
...
export default {
  ...
  computed: {
    filteredTask() {
      return this.hiddeCompleted ? this.tasks.filter(t => !t.done) : this.tasks;
    }
  },
  methods: {
    addNewTodo() {
